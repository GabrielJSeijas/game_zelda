...
const char *bases[] = {
    ...
    "Arco", "Flecha", "Cetro", "Corona", "Amuleto",
...
const char *atributos[] = {
    ...
    "de la Aurora", "de Niflheim", "de Muspelheim", "del Ragnarok", "de los Elfos",
    "de los Enanos", "de los Caídos", "de la Oscuridad", "del Amanecer", "de la Eternidad",
    "de Acero Rúnico", "de los Gigantes", "del Fin del Mundo", "de Helheim", "de la Luz"
};
